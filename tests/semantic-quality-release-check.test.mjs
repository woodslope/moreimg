...
const plan = execFileSync(process.execPath, ['scripts/semantic-quality-release-check.mjs'], {
  cwd: directory,
  encoding: 'utf8'
});
...
const verification = execFileSync(process.execPath, [
  'scripts/semantic-quality-release-check.mjs',
  '--verify',
  'fixtures/semantic-quality-results.baseline.json'
], {
  cwd: directory,
  encoding: 'utf8'
});
