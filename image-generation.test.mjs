...
assert.match(bodyVisualOnlyPrompt, /顶部50%-55%/);
assert.match(bodyVisualOnlyPrompt, /下方可用视觉区/);
...
assert.match(source, /disabled=\{selectedHtmlImageResult\?\.status !== 'success' \|\| isSelectedHtmlCardExporting\}/);
