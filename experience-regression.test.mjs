...
const styleGuide = await readFile(new URL('./UI_STYLE_GUIDE.md', import.meta.url), 'utf8');
...
assert.match(source, /renderHistoryItems\(\{ closeAfterOpen: true, mobile: true \}\)/, '桌面与窄屏历史记录应复用同一交互 owner');
