...
const printPlan = () => {
  ...
  console.log('node scripts/semantic-quality-release-check.mjs --verify fixtures/semantic-quality-results.baseline.json');
};
...
if (!command) {
  ...
  throw new Error('Usage: node scripts/semantic-quality-release-check.mjs [--verify result.json]');
}
